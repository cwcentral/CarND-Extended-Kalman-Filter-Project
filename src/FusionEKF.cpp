...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
	...
	if (!is_initialized_) {
		...
		if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
			...
			cout << "Got MeasurementPackage::RADAR: " << x << ":" << y << ":" << vx << ":" << vy << endl;
			...
			/**
			 Initialize state.
			 */
			cout << "Got MeasurementPackage::LASER: " << measurement_pack.raw_measurements_[0] << "::" << measurement_pack.raw_measurements_[1] << endl;
